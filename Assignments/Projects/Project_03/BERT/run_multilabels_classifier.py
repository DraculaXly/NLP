...
class MultiLabelTextProcessor(DataProcessor):
    ...
    def get_dev_examples(self, data_dir):
        data_df = pd.read_csv(os.path.join(data_dir, 'val.csv'))
    ...
    def get_labels(self, data_dir):
        return list(pd.read_csv(os.path.join(data_dir, 'labels.csv'), header=None)[0].values)
...
def main(_):
    ...
    processors = {
        ...
        "mrpc": MrpcProcessor,
        "xnli": XnliProcessor,
        "multilabels": MultiLabelTextProcessor
    }
